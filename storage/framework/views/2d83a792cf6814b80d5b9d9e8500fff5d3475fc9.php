...
<head>
  ...
  <!-- ICONS -->
  <link rel="icon" href="<?php echo e(asset('projectad/assets/icon/favicon.ico')); ?>" />
  ...
  <!-- CSS -->
  <link rel="stylesheet" href="<?php echo e(asset('projectad/css/owl.carousel.min.css')); ?>">
  <link rel="stylesheet" href="<?php echo e(asset('projectad/css/styles.css')); ?>" />
    ...
    <nav class="nav-head navbar fixed-top navbar-expand-lg navbar-dark">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ml-auto mr-auto">
          <li class="nav-item">
            <a class="nav-link" href="<?php echo e(url('user-home')); ?>">Home</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<?php echo e(url('user-news')); ?>">News</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<?php echo e(url('user-events')); ?>">Events</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<?php echo e(url('user-academic')); ?>">Academic</a>
          </li>
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#">Organization</a>
            <div class="dropdown-menu animated--grow-in">
              <a href="<?php echo e(url('user-about')); ?>" class="dropdown-item">About</a>
              <a href="<?php echo e(url('user-aspiration')); ?>" class="dropdown-item">Aspiration</a>
            </div>
          </li>
        </ul>
        <ul class="navbar-nav">
...
<script src="<?php echo e(asset('projectad/js/materialize.min.js')); ?>"></script>
<script src="<?php echo e(asset('projectad/js/owl.carousel.min.js')); ?>"></script>
<script src="<?php echo e(asset('projectad/js/script.js')); ?>"></script>
<script>
...
<?php /**PATH Z:\KULIAH OOO\Sem5\AD\Project\ApplicationDevelopment\ApplicationDevelopment\resources\views/client/layout/main.blade.php ENDPATH**/ ?>