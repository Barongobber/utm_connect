          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <div class="row">
                ...
                <div class="col-lg-6 img-column">
                  <a href='https://pngtree.com/so/news-clipart' style="pointer-events:none"><img class="calendar-carousel-img" src="{{asset('projectad/assets/img/news.svg')}}" alt="news"/></a>
                </div>
            ...
            <div class="carousel-item">
              <div class="row">
                ...
                <div class="col-lg-6 img-column">
                  <a href='https://pngtree.com/so/calendar-clipart' style="pointer-events:none"><img class="calendar-carousel-img" src="{{asset('projectad/assets/img/calendar.svg')}}"/></a>
                </div>
                <div class="col-lg-12 col-md-12 col-sm-12 button-column">
            ...
            <div class="carousel-item">
              <div class="row">
                ...
                <div class="col-lg-6 img-column">
                  <a href=""><img class="calendar-carousel-img" src="{{asset('projectad/assets/img/books.svg')}}"/></a>
                </div>
                <div class="col-lg-12 col-md-12 col-sm-12 button-column">
