        ...
        <div class="tab-content">
            <div class="tab-pane active" id="dashboard-1">
                <div class="dashboard-1">
                    ...
                    <?php include ('views/post/content_list.php'); ?>
                </div>
            </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button class="btn btn-info" type="button" data-dismiss="modal" onclick="window.location.href='?cms=content_management&act=news'">News</button>
                <a class="btn btn-primary" href="?cms=content_management&act=event">Event</a>
            </div>
        </div>
    </div>
</div>